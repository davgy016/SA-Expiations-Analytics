...
using ExpiationsAnalytic.Data;
using ExpiationsAnalytic.Models;
...
namespace ExpiationsAnalytic.Controllers.API
{
    ...
    public class EndpointController : Controller
    {
        ...
        static Dictionary<string, string> loginList = new Dictionary<string, string> { { "Giorgi", sha256hash("123")}, {"cool_fred", sha256hash("hunter2") }, { "large_marge", sha256hash("test123") } };
        ...
        public async Task<object> Get_ListCamerasInSuburb(string suburb, bool cameraIdsOnly = false)
        {
            ...
            var suburbs = await cameraContext.Where(i => i.Suburb.ToLower().Contains(suburb.ToLower())).Select(i => new { i.LocationId, i.CameraTypeCode, i.CameraTypeCodeNavigation.CameraType1, i.Suburb, i.RoadName, i.RoadType }).ToListAsync();
